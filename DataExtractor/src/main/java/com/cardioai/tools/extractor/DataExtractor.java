...
public class DataExtractor {
    ...
    public static void main(String[] args) {
        try {
            DataExtractorConfig config = getPayloadGeneratorConfig(args);
    ...
    private static DataExtractorConfig getPayloadGeneratorConfig(String[] args) throws IOException {
        ...
        return new DataExtractorConfig(
                manifestFilePath, fromTime, toTime, targetDirectoryPath, scriptFilePath);
    }

    private static List<String> buildExtractionCommands(DataExtractorConfig config, List<String> records) throws IOException, InterruptedException {
